...
@implementation LIEListTableView
...
- (UIView *)snapshotFromRowAtMovingIndexPath
{
    ...
    LIEListCustomCell *touchedCell = (LIEListCustomCell *)[self cellForRowAtIndexPath:self.movingIndexPath];
