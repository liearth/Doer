...
@interface LIEItemEditViewController ()

@end

@implementation LIEItemEditViewController
...
- (void)viewDidLoad {
    ...
    switch (_showOption) {
        case 0:
        {
            ...
            _myView.backgroundColor = [LIEColor ItemEditTextColor];
        ...
        case 1:
        {
            ...
            _myView.backgroundColor = [LIEColor ItemAddTextColor];
    ...
    switch (removeOption) {
        case 0:
        {
            [UIView animateWithDuration:0.5 animations:^{
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:@"ADDITEM" object:self userInfo:@{@"ITEMNAME":self.myTextField.text}];
            }];
        }
            break;
        case 1:
        {
            [UIView animateWithDuration:0.5 animations:^{
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:@"EDITITEM" object:self userInfo:@{@"ITEMNAME":self.myTextField.text}];
            }];
        }
            break;
        default:
...
- (void)editedAndRemoveController:(UIGestureRecognizer *)recognizer
{
    if (recognizer.numberOfTouches == 1) {
        ...
        [self removeItemEditViewInOption:1];
    }
}
...
- (void)addedAndRemoveController:(UIGestureRecognizer *)recognizer
{
    if (recognizer.numberOfTouches == 1) {
        ...
        [self removeItemEditViewInOption:0];
    }
}
