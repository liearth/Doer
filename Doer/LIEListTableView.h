 ...
 */
@protocol LIEListViewDelegate <NSObject, UITableViewDelegate>
 ...
 */
- (NSIndexPath *)moveTableView:(LIEListTableView *)tableView targetIndexPathForMoveFromRowAtIndexPath:(NSIndexPath *)sourceIndexPath toProposedIndexPath:(NSIndexPath *)proposedDestinationIndexPath;
 ...
 */
- (void)moveTableView:(LIEListTableView *)tableView willMoveRowAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
@protocol LIEListViewDataSource <NSObject, UITableViewDataSource>
 ...
 */
@interface LIEListTableView : UITableView <UIGestureRecognizerDelegate>

/**
 * The object that acts as the data source of the receiving table view.
 */
@property (nonatomic, weak) id <LIEListViewDataSource> dataSource;

/**
 * The object that acts as the delegate of the receiving table view.
 */
@property (nonatomic, weak) id <LIEListViewDelegate> delegate;
