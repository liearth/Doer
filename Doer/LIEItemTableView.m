...
@implementation LIEItemTableView
...
- (UIView *)snapshotFromRowAtMovingIndexPath
{
    ...
    LIEItemCustomCell *touchedCell = (LIEItemCustomCell *)[self cellForRowAtIndexPath:self.movingIndexPath];
    touchedCell.selected = NO;
    touchedCell.highlighted = NO;
    
    [touchedCell prepareForMoveSnapshot];
    
    UIView *snapshot = [touchedCell.myContentView snapshotViewAfterScreenUpdates:YES];
