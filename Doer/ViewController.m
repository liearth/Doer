    ...
    switch (state)
    {
        case UIGestureRecognizerStateBegan:
        {
            if (indexPath)
            {
                ...
                LIEListCustomCell *cell = (LIEListCustomCell *)[self.tableView cellForRowAtIndexPath:indexPath];
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            if (indexPath && ![indexPath isEqual:sourceIndexPath]) {
                ...
                // ... update data source.
                [_list exchangeObjectAtIndex:sourceIndexPath.row withObjectAtIndex:indexPath.row];
                [_listArray exchangeObjectAtIndex:sourceIndexPath.row withObjectAtIndex:indexPath.row];
                [_list replaceObjectAtIndex:_list.count - 1 withObject:_listArray];
        ...
        {
            // Clean up.
            LIEListCustomCell *cell = (LIEListCustomCell *)[self.tableView cellForRowAtIndexPath:sourceIndexPath];
            [UIView animateWithDuration:0.1 animations:^{
